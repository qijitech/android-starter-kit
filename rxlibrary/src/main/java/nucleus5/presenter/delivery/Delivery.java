...
public final class Delivery<View, T> {
  ...
  public static <View, T> Observable<Delivery<View, T>> validObservable(OptionalView<View> view,
      Notification<T> notification) {
    return isValid(view, notification) ? Observable.just(new Delivery<>(view.view, notification))
        : Observable.<Delivery<View, T>>empty();
  }

  public void split(BiConsumer<View, T> onNext, @Nullable BiConsumer<View, Throwable> onError)
      throws Exception {
  ...
  @Override public boolean equals(Object o) {
    ...
    return !(notification != null ? !notification.equals(delivery.notification)
        : delivery.notification != null);
  }
  ...
  @Override public String toString() {
    return "Delivery{" + "view=" + view + ", notification=" + notification + '}';
  }
}
