...
public class CellModel {
  ...
  public static Builder emptyCell() {
    return new Builder(VIEW_TYPE_EMPTY);
  }

  public static Builder emptyCell(int height) {
    Builder builder = new Builder(VIEW_TYPE_EMPTY);
  ...
  public static Builder shadowCell(int height) {
    Builder builder = new Builder(VIEW_TYPE_SHADOW);
    builder.cellHeight = height;
    return builder;
  }

  public static Builder headCell(String text) {
  ...
  public static Builder infoPrivacyCell(String text) {
    Builder builder = new Builder(VIEW_TYPE_TEXT_INFO_PRIVACY);
    builder.text = text;
    return builder;
  }

  public static Builder textCell(String text) {
    return textCell(null, text, true);
  }

  public static Builder textHintCell(String hint) {
    return textCell(hint, null, true);
  }

  public static Builder textCell(String hint, String text, boolean enabled) {
  ...
  public static Builder checkCell(String text) {
  ...
  public static Builder checkCell(String text, boolean checked) {
    Builder builder = new Builder(VIEW_TYPE_CHECK);
    builder.text = text;
  ...
  public static Builder settingCell(String text) {
  ...
  public static Builder detailSettingCell(String text, String detail) {
